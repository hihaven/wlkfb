            ...
            <div class="span9">
                <div class="hero-unit">
                   ...
                   请选择部门：<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    ...
                    </asp:DropDownList> 请选择年级：<asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <h2>
                            后台简述：</h2>
                        <p>
                            &nbsp; 管理员1、可以开启和结束考试。2、可以对考试的相关信息进行查看、新建编辑、删除等操作。3、可以将学生信息表、题库表、管理员表导入数据库，并可以进行查看，编辑等操作。4、可以对考试完成后学生考试成绩进行导出等操作。</p>
                    </div>
                    <!--/span-->
                    <div class="span4">
                        <h2>
                ...
                <p>
                    ...
                    <a type="button" class="btn btn-info" type="button" class="btn btn-info" href="http://www.cdcas.edu.cn/">
                        成都文理学院 &raquo;</a> <a type="button" class="btn btn-info" href="http://zzb.sicnu.edu.cn/dxzx/">
                            四川师范大学党校 &raquo;</a> <a type="button" class="btn btn-info" href="http://www.scge.gov.cn/">
                                中共四川党校 &raquo;</a> <a type="button" class="btn btn-info" href="http://www.ccps.gov.cn/">
                                    中共中央党校 &raquo;</a> <a type="button" class="btn btn-info" href="http://www.scedu.net/">
                                        四川省教育厅 &raquo;</a> <a type="button" class="btn btn-info" href="http://www.moe.gov.cn/">
                                            国家教育部 &raquo;</a>
                    <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
